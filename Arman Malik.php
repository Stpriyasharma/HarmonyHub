...
<h4><span></span><i class="bi bi-music-note-beamed"></i> Recommended</h4>
        ...
        <div class="menu_song">
            ...
            <li class="songItem">
                ...
                <h5>Hua Hai Aaj Phli Baar <br> <div class="subtitle">Armaan Malik</div>
                </h5>
            ...
            <li class="songItem">
               ...
               <img src="images/34.jpg" alt="">
                <h5>Bol Do Na Zara<br> <div class="subtitle">Armaan Malik</div>
                </h5>
            ...
            <li class="songItem">
               ...
               <img src="images/35.jpg" alt="">
                <h5>Dil Me Ho Tum<br> <div class="subtitle">Armaan Malik</div>
                </h5>
                <i class="bi playlistplay bi-play-circle-fill" id="35"></i>
            </li> <li class="songItem">
                <span>05</span>
               <img src="images/36.jpg" alt="">
                <h5>Sab Tera<br> <div class="subtitle">Armaan Malik</div>
                </h5>
            ...
            <li class="songItem">
               ...
               <img src="images/37.jpg" alt="">
                <h5>Pehla Pyaar<br> <div class="subtitle">Armaan Malik</div>
                </h5>
            ...
            <li class="songItem">
               ...
               <img src="images/38.jpg" alt="">
                <h5>Main Rahoon Ya Na Rahoon<br> <div class="subtitle">Armaan Malik</div>
                </h5>
            ...
            <li class="songItem">
               ...
               <img src="images/40.jpg" alt="">
                <h5>De Taali<br> <div class="subtitle">Armaan Malik</div>
                </h5>
            ...
            <li class="songItem">
               ...
               <img src="images/42.jpg" alt="">
                <h5>Jeene Laga Hoon<br> <div class="subtitle">Armaan Malik</div>
                </h5>
            ...
            <li class="songItem">
               ...
               <img src="images/43.jpg" alt="">
                <h5>Dil Diyaan Gallan<br> <div class="subtitle">Armaan Malik</div>
                </h5>
            ...
            <li class="songItem">
               ...
               <img src="images/44.jpg" alt="">
                <h5>Piya O Re Piya<br> <div class="subtitle">Armaan Malik</div>
                </h5>
            ...
            <li class="songItem">
               ...
               <img src="images/45.jpg" alt="">
                <h5>O Saathi <br> <div class="subtitle">Armaan Malik</div>
                </h5>
            ...
            <li class="songItem">
               ...
               <img src="images/46.jpg" alt="">
                <h5>Dekhte Dekhte <br> <div class="subtitle">Armaan Malik</div>
                </h5>
    ...
    <div class="popular_song">
        ...
        <div class="pop_song">
          ...
          <img src="images/47.jpg" alt="">
            ...
            <h5>Tajdar-E-Haram <br> <div class="subtitle">Armaan Malik</div>
            </h5>
        </li> 
        <li class="songItem">
            <div class="img_play">
          <img src="images/48.jpg" alt="">
             ...
             <h5>Chogada <br> <div class="subtitle">Armaan Malik</div>
             </h5>
         </li>
         <li class="songItem">
            <div class="img_play">
          <img src="images/49.jpg" alt="">
             ...
             <h5>Woh Lamhe Woh Raatein <br> <div class="subtitle">Armaan Malik</div>
             </h5>
         </li>
         <li class="songItem">
            <div class="img_play">
    ...
    <div class="popular_artists">
     ...
     <div class="music_play">
      ...
      <img src="images/7.jpg" alt="" id="poster_music_play">
        <h5 id="title">
            Besabriyaan
            <div class="subtitile">Armaan Malik</div>
        </h5>
        <div class="icons">
    ...
    <script src="Arman malik.js"></script>
    <script>
